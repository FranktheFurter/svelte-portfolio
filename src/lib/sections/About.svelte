...
<section id="about" class="mb-24 nav-bar-scroll-margin">
  ...
  <div class="flex flex-col md:flex-row gap-8">
    <div class="bg-gray-800/50 rounded-2xl flex-1 relative">
      <div class="clearfix">
        ...
        <p class="text-gray-300">
          ...
          />
          I graduated in computer engineering from Ulm, specializing in usability
          engineering and UI development.<br /><br />
          Initially working as a UX designer, I eventually shifted towards a more
          technical role due to my love for development. I thrive on the intricate
          process of combining individual elements in both programming and designing.
        </p>
        <div class="mt-6">
          <a
    ...
    <div class="bg-gray-800/50 rounded-2xl flex-1">
